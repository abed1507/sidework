...
<body>
  <div class="form">
      ...
      <div class="tab-content">
        <div id="signup">   
          <h1>Sign Up for Course Enrollment</h1>
	...
	<div class="field-wrap">
		...
		<div class="field-wrap">
          ...
          <button type="submit" id = "button" name="register" class="button button-block"/>Get Started</button>
        ...
        <div id="login">   
          ...
          <form action="loginCheck.php" method="post">
            ...
            <input type="text"required autocomplete="off" name="uname" id="username"/>
          </div>
          ...
          <div class="field-wrap">
            ...
            <input type="password"required autocomplete="off" name="psw" id="password"/>
          </div>
